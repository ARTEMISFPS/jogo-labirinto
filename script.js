    ...
    map.forEach((item) => {
        ...
        item.split("").map((i) => {
            ...
            if (i === " ") {
                ...
                if (i === "1") { gema.setAttribute("src", "assets/sprite/planta.png") }
                else if (i === "2") { gema.setAttribute("src", "assets/sprite/planta.png") }
                else if (i === "3") { gema.setAttribute("src", "assets/sprite/planta.png") }
                else if (i === "4") { gema.setAttribute("src", "assets/sprite/planta.png") }
                else if (i === "5") { gema.setAttribute("src", "assets/sprite/planta.png") }
                else if (i === "6") { gema.setAttribute("src", "assets/sprite/planta.png") }
